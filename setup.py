...
VERSION = get_version('my_app', '__init__.py')
...
setup(
    ...
    author='dlowji',
    author_email='dev.loivo2k2@gmail.com',
    url='https://github.com/openedx/my_repo',
    packages=find_packages(
        include=['my_app', 'my_app.*'],
        exclude=["*tests"],
    ),
