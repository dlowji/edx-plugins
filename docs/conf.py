...
"""
my_project documentation build configuration file.
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/my_repo",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'short desc',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'my_app'),
                os.path.join(root_path, 'my_app/migrations')])
